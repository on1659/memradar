...
const translations = {
  ko: {
    ...
    'accent.violet': '바이올렛',
    'replay.open': '리플레이 재생',
    'replay.back': '세션으로 돌아가기',
    'replay.keyboardHint': 'Space · ← → · Esc',
    'replay.play': 'Space 재생/일시정지',
    'replay.prev': '← 이전 메시지',
    'replay.next': '→ 다음 메시지',
    'replay.speed': '재생 속도',
    'replay.gap.minutes': '{minutes}분 후',
    'replay.gap.hours': '{hours}시간 후…',
    'replay.you': 'You',
    'replay.tools': '도구',
  ...
  en: {
    ...
    'dashboard.personality': 'Overall Type',
    ...
    'replay.open': 'Replay',
    'replay.back': 'Back to session',
    'replay.keyboardHint': 'Space · ← → · Esc',
    'replay.play': 'Space play/pause',
    'replay.prev': '← Previous message',
    'replay.next': '→ Next message',
    'replay.speed': 'Playback speed',
    'replay.gap.minutes': '{minutes} min later',
    'replay.gap.hours': '{hours}h later…',
    'replay.you': 'You',
    'replay.tools': 'Tools',
